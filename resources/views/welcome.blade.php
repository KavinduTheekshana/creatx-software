...
<section class="main-slider">
    ...
    "autoplay": {
        ...
        <div class="swiper-wrapper">
                ...
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-xl-7 col-lg-12 text-right">
                            ...
                            <a href="services" data-target=".donate-options" class="scroll-to-target thm-btn dynamic-radius">Our Services</a>
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(assets/images/main-slider/slider-1-6.jpg);"></div>
                <!-- /.image-layer -->
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-xl-8 col-lg-12 text-right">
                            ...
                            <a href="about" data-target=".donate-options" class="scroll-to-target thm-btn dynamic-radius">About Us</a>
                            <!-- /.thm-btn dynamic-radius -->
                        </div><!-- /.col-lg-7 text-right -->
                    </div><!-- /.row -->
                </div><!-- /.container -->
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(assets/images/main-slider/slider-1-5.jpg);"></div>
                <!-- /.image-layer -->
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-lg-7 text-right">
                            ...
                            <a href="hosting" data-target=".donate-options" class="scroll-to-target thm-btn dynamic-radius">Hosting Services</a>
                            <!-- /.thm-btn dynamic-radius -->
                        </div><!-- /.col-lg-7 text-right -->
                    </div><!-- /.row -->
                </div><!-- /.container -->
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(assets/images/main-slider/slider-1-4.jpg);"></div>
                <!-- /.image-layer -->
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-lg-7 text-right">
                            <p>CreatX Support Platform</p>
                            <h2>Smooth <br> Customer <br> Experience</h2>
                            <a href="contact" data-target=".donate-options" class="scroll-to-target thm-btn dynamic-radius">Contact us</a>
                            <!-- /.thm-btn dynamic-radius -->
                        </div><!-- /.col-lg-7 text-right -->
                    </div><!-- /.row -->
                </div><!-- /.container -->
...
<section class="service-one pt-120 pb-90" style="background-image: url(assets/images/backgrounds/service-hand-bg-1-3.png);">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 ">
                <div class="about-counter__image clearfix wow fadeInRight" data-wow-duration="1500ms">
                    ...
                    <img src="assets/images/resources/about-counter-1-1.jpg" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); margin-bottom: 20px;" height="692px" alt="" class="float-left">
...
<section class="causes-page causes-home pt-120 pb-120">
    <div class="container">
        ...
        <div class="news-3-col">
            <div class="blog-card">
                <div class="blog-card__inner">
                    <img src="assets/images/icon/statistics2.svg" width="80px" style="padding-top: 30px; display: block; margin-left: auto; margin-right: auto;" alt="">
                    <div class="blog-card__content">
                        <br>
                        <h3><a href="news-details.html">Finance and Insurance</a></h3>
                        <p style="padding-left: 40px; padding-right: 40px;">We've designed and deployed smart, custom-built technology
            ...
            <div class="blog-card">
                <div class="blog-card__inner">
                    <img src="assets/images/icon/health-insurance.svg" width="80px" style="padding-top: 30px; display: block; margin-left: auto; margin-right: auto;" alt="">
                    <div class="blog-card__content">
                        <br>
                        <h3><a href="news-details.html">Healthcare</a></h3>
                        <p style="padding-left: 40px; padding-right: 40px;">Our efficiency solutions for healthcare and life sciences
            ...
            <div class="blog-card">
                <div class="blog-card__inner">
                    <img src="assets/images/icon/hook2.svg" width="80px" style="padding-top: 30px; display: block; margin-left: auto; margin-right: auto;" alt="">
                    <div class="blog-card__content">
                        <br>
                        <h3><a href="news-details.html">Construction</a></h3>
                        <p style="padding-left: 40px; padding-right: 40px;">Our custom
            ...
            <div class="blog-card">
                <div class="blog-card__inner">
                    <img src="assets/images/icon/wholesaler2.svg" width="80px" style="padding-top: 30px; display: block; margin-left: auto; margin-right: auto;" alt="">
                    <div class="blog-card__content">
                        <br>
                        <h3><a href="news-details.html">Wholesale</a></h3>
                        <p style="padding-left: 40px; padding-right: 40px;">The CRM systems we have designed and supported handle
            ...
            <div class="blog-card">
                <div class="blog-card__inner">
                    <img src="assets/images/icon/mortarboard2.svg" width="80px" style="padding-top: 30px; display: block; margin-left: auto; margin-right: auto;" alt="">
                    <div class="blog-card__content">
                        <br>
                        <h3><a href="news-details.html">Education</a></h3>
                        <p style="padding-left: 40px; padding-right: 40px;">We're a little nerdy, so we know a lot about education. From
            ...
            <div class="blog-card">
                <div class="blog-card__inner">
                    <img src="assets/images/icon/delivery2.svg" width="80px" style="padding-top: 30px; display: block; margin-left: auto; margin-right: auto;" alt="">
                    <div class="blog-card__content">
                        <br>
                        <h3><a href="news-details.html">Transportation</a></h3>
                        <p style="padding-left: 40px; padding-right: 40px;">From dispatching and job assignments to cargo tracking,
        ...
        <div class="row">
                ...
                <div class="donate-options__content">
                    ...
                    <div class="donate-options__call">
                        ...
                        <div class="donate-options__call-content">
                            <p>Have any question about host? <br> <span>Call us now:</span> <a href="tel:+94 71 542 14 23">+94 71 542 14 23</a></p>
            ...
            <div class="col-lg-6">
                <div class="donate-options__form wow fadeInUp" style="overflow: hidden; padding: 0px;">
                    <img src="assets/images/resources/about-counter-1-4.jpg" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" height="592px" alt="">
                </div>
                ...
                <div class="swiper-slide">
                    <div class="gallery-card">
                        ...
                        <div class="gallery-content">
                            <a href="assets/images/gallery/gallery-2-1.jpg" class="img-popup" aria-label="open image"><i class="fal fa-search"></i></a>
                        </div><!-- /.gallery-content -->
                    </div><!-- /.gallery-card -->
                </div><!-- /.swiper-slide -->
                <div class="swiper-slide">
                    <div class="gallery-card">
                        ...
                        <div class="gallery-content">
                            <a href="assets/images/gallery/gallery-2-2.jpg" class="img-popup" aria-label="open image"><i class="fal fa-search"></i></a>
                        </div><!-- /.gallery-content -->
                    </div><!-- /.gallery-card -->
                </div><!-- /.swiper-slide -->
                <div class="swiper-slide">
                    <div class="gallery-card">
                        ...
                        <div class="gallery-content">
                            <a href="assets/images/gallery/gallery-2-3.jpg" class="img-popup" aria-label="open image"><i class="fal fa-search"></i></a>
                        </div><!-- /.gallery-content -->
                    </div><!-- /.gallery-card -->
                </div><!-- /.swiper-slide -->
                <div class="swiper-slide">
                    <div class="gallery-card">
                        ...
                        <div class="gallery-content">
                            <a href="assets/images/gallery/gallery-2-4.jpg" class="img-popup" aria-label="open image"><i class="fal fa-search"></i></a>
                        </div><!-- /.gallery-content -->
                    </div><!-- /.gallery-card -->
                </div><!-- /.swiper-slide -->
                <div class="swiper-slide">
...
<div class="google-map__home">
    <iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=place_id:EilBbmFuZGFtYWl0aHJlZSBSZCwgUGFubmlwaXRpeWEsIFNyaSBMYW5rYSIuKiwKFAoSCe2LQm5pUOI6ETSj-QYXd42QEhQKEgld783NSlDiOhGk9-a4c_7mdA&key=AIzaSyAcuvYDk04jY_H-o_EIcdr8vQi3Mz0eWnc" allowfullscreen></iframe>
